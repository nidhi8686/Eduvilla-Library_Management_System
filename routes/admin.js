...
router.get('/additems',(req,res)=>{
    ...
    // {
        ...
        db.query(getData,["s_no"],(err,result)=>{
            if (err) throw err;
            res.render('../views/Pages/Admin/Additems.ejs',{ bookdata : result ,user:session });
...
router.get('/issueditems',(req,res)=>{
    ...
    db.query(getData,(err,result)=>{
        ...
        db.query(membersdata,(err,resultmembers)=>{
            if(err) throw err;
            res.render('Pages/Admin/issueditems',{user:session,issuedbooks:result,members:resultmembers});
        })
...
router.get('/stocks',(req,res)=>{
    ...
    db.query(getData,(err,result)=>{
        ...
        db.query(getData2,(err,result2)=>{
            if(err) throw err;
             res.render('Pages/Admin/stocks',{user:session,booksavail:result,booksnotavail:result2})
        })
